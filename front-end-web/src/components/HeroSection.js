...
function HeroSection() {
    ...
    <>
        ...
        <div className="intro-section">
            ...
            <Introduction image="../images/diverse.png" alt="big data" header="4.0资源" description="所有需要的冲4.0资源    4.0 = 辅导+答疑+刷题" text="UWise 有专业的本校4.0学生做tutor, 我们提供各种课程以及tutoring 并搭配专业的答疑老师进行群内实时答疑；同时 我们收录了近5年的所有科目和考试题 作为强大题库，配套给学生刷题以帮助大家更好的保A冲4.0 " button="4.0资源" src="/classes"/>
